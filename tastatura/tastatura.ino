    ...
    #define redLed 13
    #define greenLed 12
    char code_ante= NO_KEY;
    char code_now=NO_KEY;
    long duration;
    ...
    void loop()
    {
          delay(15);
          code_ante=code_now;
          code_now=myKeypad.getKey();

          if (code_now!=NO_KEY && code_ante==NO_KEY){
            kbhit=1;
            keypressed=code_now;
...
void enterPassword() {
      ...
      lcd.print("Parola>");
          ...
          if (k > 11 || keypressed == '#') {
            ...
            if ( tempPassword == password && k==11) {
              activated = false;
              valid=true;
              } else if (tempPassword != password && k==11) {
              lcd.setCursor(0,1);
